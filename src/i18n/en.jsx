...
const translation_en = {
    ...
    drawer: {
        warning: 'Warning: This page is not included in the list, please be cautious',
        success: 'Success',
        error: 'Error',
        completed_scan: 'Security scan completed',
        you_are_authorizing: 'You are authorizing the assets in your wallet to the following address',
